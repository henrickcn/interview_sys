<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"F:\phpStudy\PHPTutorial\WWW\interview_sys\public/../app/admin\view\config\config_list.html";i:1525249071;s:94:"F:\phpStudy\PHPTutorial\WWW\interview_sys\public/../app/admin\view\layout\batch_btn_group.html";i:1525249071;}*/ ?>
<div class="box">
  <div class="box-header">
    ...
    <div class="box-tools ">
        <div class="input-group input-group-sm search-form">
            <input name="search_data" class="pull-right search-input" value="<?php echo input('search_data'); ?>" placeholder="请输入配置名称或标题" type="text">
            <div class="input-group-btn">
              <button type="button" id="search" url="<?php echo url('configlist'); ?>" class="btn btn-default"><i class="fa fa-search"></i></button>
            </div>
        </div>
    </div>
