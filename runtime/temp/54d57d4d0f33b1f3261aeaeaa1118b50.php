<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"F:\phpStudy\PHPTutorial\WWW\interview_sys\public/../app/admin\view\api\api_list.html";i:1525249071;s:94:"F:\phpStudy\PHPTutorial\WWW\interview_sys\public/../app/admin\view\layout\batch_btn_group.html";i:1525249071;}*/ ?>
<div class="box">
  <div class="box-header">
        <ob_link><a class="btn" href="<?php echo url('apiAdd'); ?>"><i class="fa fa-plus"></i> 新 增</a></ob_link>
        <a class="btn" href="<?php echo url('api/index/index'); ?>" target="_blank"><i class="fa fa-book"></i> 接口文档</a>
        
        <div class="box-tools ">
            <div class="input-group input-group-sm search-form">
                <input name="search_data" class="pull-right search-input" value="<?php echo input('search_data'); ?>" placeholder="请输入接口名称" type="text">
                <div class="input-group-btn">
                  <button type="button" id="search" url="<?php echo url('apilist'); ?>" class="btn btn-default"><i class="fa fa-search"></i></button>
                </div>
            </div>
        </div>
        <br/>
