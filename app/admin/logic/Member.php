...
class Member extends AdminBase
{
     ...
     * 获取会员列表
     */
    public function getMemberList($where = [], $field = 'm.*,b.nickname as leader_nickname,d.name as groupname', $order = 'm.id DESC', $paginate = DB_LIST_ROWS)
    {
        ...
        $join = [
                    ...
                    [SYS_DB_PREFIX . 'auth_group_access c', 'm.id = c.member_id', 'LEFT'],
                    [SYS_DB_PREFIX . 'auth_group d', 'c.group_id = d.id', 'LEFT'],
                ];
